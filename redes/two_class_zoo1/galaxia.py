...
def train(model):
    ...
    dataset_train.load_galaxia(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = galaxiaDataset()
    dataset_val.load_galaxia(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect galaxias.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/galaxia/dataset/",
                        help='Directory of the galaxia dataset')
